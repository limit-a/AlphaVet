				...
				<div
					...
					<div class="page-title-right">
						<ol class="breadcrumb m-0">
							<li class="breadcrumb-item"><a href="javascript: void(0);">Madroc</a></li>
						...
						<div class="card overflow-hidden card-h-100">
							<div class="card-body">
								...
								<h3 class="font-size-24">
									26.46% <span class="text-success fw-normal font-size-14 ms-2">+8.34%</span>
								</h3>
					...
					<div class="col-md-6 col-xl-4">
						<div class="card overflow-hidden card-h-100">
							<div class="card-body">
								...
								<h3 class="font-size-24">
									46,562 <span class="text-danger fw-normal font-size-14 ms-2">+3.16%</span>
								</h3>
								<p class="text-muted mb-0">Total Users World wide</p>
							</div>
							<!-- end card-body -->
					...
					<div class="col-xl-4">
						<div class="card overflow-hidden card-h-100">
							<div class="card-body">
								...
								<h3 class="font-size-24">
									2048<span class="text-danger fw-normal font-size-14 ms-2">+3.16%</span>
								</h3>
								<p class="text-muted mb-0">Total Users World wide</p>
							</div>
							<!-- end card-body -->
				...
				<div class="card congo-widget overflow-hidden">
					<div class="card-body">
						<div class="row align-items-center">
							<div class="col-8">
								<div>
									<h4 class="font-size-24 text-white text-truncate">Best
										Employee Shonen</h4>
									<p class="text-white-50 mt-3">
										Thanks For begin such in our Medroc. You have done <b
											class="text-white">57.6%</b> more sales today
									</p>
							...
							<div class="col-4">
								<div>
									<img src="${pageContext.request.contextPath }/resources/assets/images/sales-img-2.png" class="img-fluid" alt="">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row align-items-center">
							...
							<div class="col-xl-4">
								...
								<p class="text-muted">Curabitur lacinia eleifend justo eget
									lobortis ipsum feugiat ornare.</p>
								<div class="mt-3">
						...
						<div class="row mt-1">
							<div class="col border-end">
								<div class="text-center py-2">
									<p class="text-uppercase mb-0 text-muted">
										<i
			...
			<div class="col-xl-4">
							...
							<div class="carousel-inner">
									...
									<div class="d-flex mt-4">
										<div class="text-center">
											<img class="rounded-circle header-profile-user avatar-sm"
												src="${pageContext.request.contextPath }/resources/assets/images/users/avatar-2.jpg" alt="Header Avatar">
											<div class="mt-n4">
												<i class="ri-double-quotes-r text-primary h1"></i>
											</div>
										</div>
										<div class="flex-grow-1 ms-3">
											<p class="text-muted">“I feel confident imposing change
												on myself. It's a lot more fun progressing than looking
												back. That's why I need to throw curve balls.”</p>
											<h5 class="font-size-15">Nicholas Morris</h5>
											<ul class="list-inline mb-1 ps-0">
												<li class="list-inline-item me-0"><i
													class="ri-star-s-fill text-warning"></i></li>
												<li class="list-inline-item me-0"><i
													class="ri-star-s-fill text-warning"></i></li>
												<li class="list-inline-item me-0"><i
													class="ri-star-s-fill text-warning"></i></li>
								...
								<div class="carousel-item" data-bs-interval="2000">
									<div class="d-flex mt-4">
										<div class="text-center">
											<img class="rounded-circle header-profile-user avatar-sm"
												src="${pageContext.request.contextPath }/resources/assets/images/users/avatar-3.jpg" alt="Header Avatar">
											<div class="mt-n4">
												<i class="ri-double-quotes-r text-primary h1"></i>
											</div>
										</div>
										<div class="flex-grow-1 ms-3">
											<p class="text-muted">“Our task must be to free ourselves
								...
								<div class="carousel-item">
									<div class="d-flex mt-4">
										<div class="text-center">
											<img class="rounded-circle header-profile-user avatar-sm"
												src="${pageContext.request.contextPath }/resources/assets/images/users/avatar-4.jpg" alt="Header Avatar">
											<div class="mt-n4">
												<i class="ri-double-quotes-r text-primary h1"></i>
											</div>
										</div>
										<div class="flex-grow-1 ms-3">
											<p class="text-muted">“I've learned that people will
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="my-1">
							<p class="mb-2">
								This Month <span class="float-end">75%</span>
							</p>
							...
							<p class="mt-4 mb-2">
								Last Month <span class="float-end">55%</span>
							</p>
							<div class="progress mt-2" style="height: 6px;">
							...
							<p class="mt-4 mb-2">
								This Year <span class="float-end">52%</span>
							</p>
							<div class="progress mt-2" style="height: 6px;">
								<div class="progress-bar progress-bar-striped bg-danger"
									role="progressbar" style="width: 52%" aria-valuenow="52"
									aria-valuemin="0" aria-valuemax="52"></div>
							</div>
						</div>
					</div>
					<!-- end card-body -->
						...
						<div data-simplebar style="max-height: 400px;">
							<ol class="activity-feed mb-0 ps-3 mt-4 pt-2 pb-0">
								...
								<li class="feed-item">
									...
									<p class="mt-0 mb-0">
										Andrei Coman posted a new article <span class="text-primary">
											Designer Alex</span>
									</p>
								</li>
								<li class="feed-item">
								...
								<li class="feed-item pb-1">
									...
									<p class="mt-0 mb-0">
										Andrei Coman posted a new article: <span class="text-primary">Designer
											Alex</span>
									</p>
								</li>
							</ol>
							...
							<table class="table table-centered table-nowrap mb-0">
								...
								<tbody>
									<tr>
										...
										<td>$120.00</td>
										<td><span
											class="badge rounded-pill badge-soft-success font-size-12">In
												Stock</span></td>
										<td><a href="" class="btn btn-outline-secondary btn-sm">View
												Details</a></td>
									</tr>
									...
									<tr>
										<td>
											<div class="d-flex align-items-center">
												<div class="avatar-xs">
													<span
														class="avatar-title rounded bg-primary font-size-20 mini-stat-icon">
									...
									<tr>
										...
										<td>$650.00</td>
										<td><span
											class="badge rounded-pill badge-soft-danger font-size-12">Out
												Of Stock</span></td>
										<td><a href="" class="btn btn-outline-secondary btn-sm">View
												Details</a></td>
